...
/**
 * Represents a specific type of {@link ErrorHandler} which gathers as many errors as possible to be displayed later for either
 * logging purposes or to propagate an exception with the full list of errors.
 * <p/>
 * Any implementation must be careful on how to treat the {@link ErrorHandler#fatalError(SAXParseException)} method, as if the
...
public interface XmlGathererErrorHandler extends ErrorHandler {
  ...
  /**
   * @return a collection with all the {@link SAXParseException} exceptions gathered from
   *         {@link ErrorHandler#error(SAXParseException)}.
   *         <p/>
